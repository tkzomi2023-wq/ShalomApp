    ...
    <div className="fixed inset-0 z-50 overflow-hidden pointer-events-auto">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="h-1.5 bg-gradient-to-r from-emerald-500 via-indigo-500 to-violet-500"></div>
          ...
          {/* Footer Controls */}
          <div className="px-5 py-3.5 bg-stone-50 dark:bg-stone-950/40 border-t border-stone-100 dark:border-stone-800 flex items-center justify-between gap-3">
            {/* Dots */}
